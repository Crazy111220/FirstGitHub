...
public class Dept2Example {
     ...
     * This field corresponds to the database table dept2
     *
     * @mbg.generated
     * @author hewei
     */
     ...
     * This method corresponds to the database table dept2
     *
     * @mbg.generated
     * @author hewei
     */
     ...
     * @author hewei
     */
    public Dept2Example limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @author hewei
     */
    public Dept2Example limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @author hewei
     */
    public Dept2Example page(Integer page, Integer pageSize) {
